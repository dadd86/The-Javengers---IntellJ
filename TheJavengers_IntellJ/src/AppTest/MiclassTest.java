...
class MiclassTest {
    ...
    void testAgregarSocioEstandar() {
        ...
        TipoSeguro tipoSeguro = "B"; // Basico
        ...
        SocioEstandar socio = controladorSocios.buscarSocioPorId(idSocio); // Asumiendo que tienes un método buscarElemento
        ...
        assertEquals(TipoSeguro.BASICO, socio.getSeguro(), "El tipo de seguro debería ser BASICO.");
    }
